...
interface ColumnMetadataFileUploaderProps {
  buildingDesignUuid: string;
}

export default function ColumnMetadataFileUploader({
  buildingDesignUuid,
}: ColumnMetadataFileUploaderProps) {
  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    ...
    formData.append("design_drawing_component_metadata_type", "FRAMING_PLAN");
    formData.append("design_drawing_component_metadata_subtype", "COLUMN");
