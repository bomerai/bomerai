...
TOKEN = """eyJhbGciOiJSUzI1NiIsImtpZCI6IlhrUFpfSmhoXzlTYzNZS01oRERBZFBWeFowOF9SUzI1NiIsInBpLmF0bSI6ImFzc2MifQ..If-l9wbjlakvU8PdGjZlz8STRtanX1qvJhq9y7Xo7luorIjsKN0kyA6EAT81GnT03AdJ-VXw_tc9VCIdKcw8WFpBJzSbgeUEFFo-dw8F6cNOByYLcyIgsl_EzFB-3vAU2eUfl2pLScyLsgQDEondDOaQwSUkgetKCH9oi8g5WPU2BIxqmE87xxC8ebFKK9ENX6iKTnSh8xhwuT5Y3VhX9REtqPFhiqvd-5HfxgvkUuiahFxE8xUDt2FjOcgiYyVGoeBHMOdegSmTPRqga9sYBwIJA798ZJc2VZGLjs_SVc8khKd9AZbaS2MpEzFyoCMJJlg4NK9h6fbHiy1Ukhcs4w"""
...
def upload_file_to_bucket():
    ...
    file_path = os.path.join(os.path.dirname(__file__), "house-floor-plan.dwg")
...
def get_object_id_from_file_on_bucket() -> str:
    headers = {"Authorization": f"Bearer {TOKEN}", "Content-Type": "application/json"}

    file_name = "house-floor-plan.dwg"
